...
### csv file includes a patient identifier, followed by age, age group and   ###
### some data relative to the type of the scan. Then 3D coordinates are      ###
### included for each of the 19 anatomical landmarks considered in our study ###
